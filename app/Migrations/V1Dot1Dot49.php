...
class V1Dot1Dot49 extends V1Dot1Dot21
{
    public function up(): void
    {
        ...
        $this->execute("ALTER TABLE `attribute_group` ADD attribute_tab_id VARCHAR(24) DEFAULT NULL COLLATE utf8mb4_unicode_ci");
        $this->execute("CREATE INDEX IDX_ATTRIBUTE_TAB_ID ON `attribute_group` (attribute_tab_id)");
    }

    public function down(): void
    {
        $this->execute("DROP TABLE attribute_tab");
        $this->execute("DROP INDEX IDX_ATTRIBUTE_TAB_ID ON `attribute_group`");
        $this->execute("ALTER TABLE `attribute_group` DROP attribute_tab_id");
    }
}
