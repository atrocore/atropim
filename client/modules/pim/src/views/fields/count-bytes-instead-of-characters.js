...
Espo.define('pim:views/fields/count-bytes-instead-of-characters', 'views/fields/bool', Dep => {
                    ...
                    if (this.model.urlRoot === 'Attribute') {
                        ...
                        if (this.model.get('attributeId')) {
                            this.ajaxGetRequest(`Attribute/${this.model.get('attributeId')}`).success(attribute => {
                                ...
                                if (this.mode === 'edit' && this.model.isNew() && attribute.countBytesInsteadOfCharacters) {
