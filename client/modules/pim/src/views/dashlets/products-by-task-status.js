...
Espo.define('pim:views/dashlets/products-by-task-status', 'views/dashlets/abstract/base',
    Dep => Dep.extend({

        _template: '<div class="list-container">{{{list}}}</div>',

        collectionUrl: 'Dashlet/ProductsByTaskStatus',
        ...
        afterRender: function () {
            this.getCollectionFactory().create('ProductsByTaskStatusDashlet', function (collection) {
                ...
                collection.model = collection.model.extend({
                    defs: {
                        fields: {
                            name: {
                                labelMap: this.translate('taskStatus', 'options', 'Product')
                            }
                        }
                    }
                });
